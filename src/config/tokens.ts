import { ChainId, Ether, KANGA_ADDRESS, Token, WETH9, WNATIVE } from '@kangafinance/sdk'
...
export const MATIC: { [key: string]: Token } = {
  ...
  KANGA: new Token(ChainId.MATIC, '0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a', 18, 'KANGA', 'KangaToken'),
...
export const HARMONY_TESTNET: { [key: string]: Token } = {
  DAI: new Token(ChainId.HARMONY, '0xa6610F1ba3523352d5Da5FB2e25c0D8859da4007', 18, 'DAI', 'Dai Stablecoin'),
  USDC: new Token(ChainId.HARMONY, '0x2E89d104f10e1D480D47e924f3F43672C09D12a2', 6, 'USDC', 'USD Coin'),
  USDT: new Token(ChainId.HARMONY, '0x922337914E641E830cE174f52288bD7660ef83C6', 6, 'USDT', 'Tether USD'),
  WBTC: new Token(ChainId.HARMONY, '0x6c4387C4f570Aa8cAdcaFFc5E73ecb3D0F8Fc593', 8, 'WBTC', 'Wrapped Bitcoin'),
  WETH: new Token(ChainId.HARMONY, '0x7466d7d0C21Fa05F32F5a0Fa27e12bdC06348Ce2', 18, 'WETH', 'Wrapped Ether'),
}
...
export const KMOB = new Token(ChainId.MAINNET, '0x650F44eD6F1FE0E1417cb4b3115d52494B4D9b6D', 18, 'KMOB', 'KMob')
...
export const XKANGA_CALL = new Token(
  ChainId.MAINNET,
  '0xada279f9301C01A4eF914127a6C2a493Ad733924',
  18,
  'XSUc25-0531',
  'XKANGA 25 Call [31 May 2021]'
)
export const WBTC = new Token(ChainId.MAINNET, '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599', 8, 'WBTC', 'Wrapped BTC')

export const XKANGA = new Token(
  ChainId.MAINNET,
...
export const CRXKANGA = new Token(
  ChainId.MAINNET,
...
export const AXKANGA = new Token(
  ChainId.MAINNET,
  '0xF256CC7847E919FAc9B808cC216cAc87CCF2f47a',
  18,
  'aXKANGA',
  'Aave interest bearing XKANGA'
)
...
// KANGA
export const KANGA: ChainTokenMap = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, KANGA_ADDRESS[ChainId.MAINNET], 18, 'KANGA', 'KangaToken'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, KANGA_ADDRESS[ChainId.ROPSTEN], 18, 'KANGA', 'KangaToken'),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, KANGA_ADDRESS[ChainId.RINKEBY], 18, 'KANGA', 'KangaToken'),
  [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, KANGA_ADDRESS[ChainId.GÖRLI], 18, 'KANGA', 'KangaToken'),
  [ChainId.KOVAN]: new Token(ChainId.KOVAN, KANGA_ADDRESS[ChainId.KOVAN], 18, 'KANGA', 'KangaToken'),
  [ChainId.MATIC]: new Token(ChainId.MATIC, KANGA_ADDRESS[ChainId.MATIC], 18, 'KANGA', 'KangaToken'),
  [ChainId.FANTOM]: new Token(ChainId.FANTOM, KANGA_ADDRESS[ChainId.FANTOM], 18, 'KANGA', 'KangaToken'),
  [ChainId.XDAI]: new Token(ChainId.XDAI, KANGA_ADDRESS[ChainId.XDAI], 18, 'KANGA', 'KangaToken'),
  [ChainId.BSC]: new Token(ChainId.BSC, KANGA_ADDRESS[ChainId.BSC], 18, 'KANGA', 'KangaToken'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, KANGA_ADDRESS[ChainId.AVALANCHE], 18, 'KANGA', 'KangaToken'),
  [ChainId.OKEX]: new Token(ChainId.OKEX, KANGA_ADDRESS[ChainId.OKEX], 18, 'KANGA', 'KangaToken'),
  [ChainId.HARMONY]: new Token(ChainId.HARMONY, KANGA_ADDRESS[ChainId.HARMONY], 18, 'KANGA', 'KangaToken'),
  [ChainId.HARMONY_TESTNET]: new Token(
    ChainId.HARMONY_TESTNET,
    KANGA_ADDRESS[ChainId.HARMONY_TESTNET],
    18,
    'KANGA',
    'KangaToken'
  ),
  [ChainId.HECO]: new Token(ChainId.HECO, KANGA_ADDRESS[ChainId.HECO], 18, 'KANGA', 'KangaToken'),
}
