...
import troopLogo from '../../../public/troop-logo.png'
            ...
            <div className="flex justify-center col-span-12 xl:col-span-3 lg:justify-start">
              <Link href="/borrow">
                <a className="flex justify-center xl:justify-start xl:mx-8">
                  <Image src={troopLogo} alt="Troop" height={64} width={250} />
                </a>
              </Link>
            </div>
            <div className="flex items-end col-span-12 xl:col-span-9">
              <nav className="flex items-center justify-between w-full">
                <div className="flex">
                  ...
                  <NavLink href="/troop/create">
                    <a
                      className={
                        'px-2 sm:px-4 flex items-center font-medium ' +
                        (router.pathname.startsWith('/troop/create')
                          ? 'text-high-emphesis'
                          : 'text-secondary hover:text-primary')
                      }
                    >
                ...
                <div className="flex pr-2 sm:pr-4">
                  <NavLink href="/balances">
                    ...
                    >
                      ...
                      <div className="text-base whitespace-nowrap">Mob</div>
                      {/* <div className="ml-2 text-base whitespace-nowrap">
                                                {formatNumber(
                                                    balances
                                                        ?.reduce((previousValue, currentValue) => {
                                                            return previousValue.add(currentValue.mob.usdValue)
                                                        }, Zero)
