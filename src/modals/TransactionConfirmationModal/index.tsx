...
import { ChainId, Currency } from '@kangafinance/sdk'
...
import loadingBounceingCircle from '../../animation/loading-rolling-circle.json'
  ...
  return (
    <div>
      ...
      <div className="w-24 pb-4 m-auto">
        <Lottie animationData={loadingBounceingCircle} autoplay loop />
      </div>
