import { ChainId, Currency, NATIVE, Token } from '@kangafinance/sdk'
...
import CHAINLINK_TOKENS from '@kangafinance/chainlink-whitelist/dist/kangafinance-chainlink.whitelist.json'
...
export function CurrencySearch({
  ...
  if (router.asPath.startsWith('/troop/create')) {
