import { ChainId, Currency, NATIVE, KANGA_ADDRESS } from '@kangafinance/sdk'
            ...
            <div className="px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Image src="/logo.png" alt="Kanga" width="32px" height="32px" />
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                    {chainId && [ChainId.MAINNET].includes(chainId) && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add xKANGA to your MetaMask wallet`)}>
                          <div
                              ...
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                const params: any = {
                                  ...
                                  options: {
                                    ...
                                    decimals: 18,
                                    image:
                                      'https://raw.githubusercontent.com/kangafinance/assets/master/blockchains/ethereum/assets/0x8798249c2E607446EfB7Ad49eC89dD1865Ff4272/logo.png',
                                  },
                                }
                                library.provider
                                  .request({
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added XKANGA to MetaMask')
                                    } else {
                    ...
                    {chainId && chainId in KANGA_ADDRESS && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add KANGA to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              const params: any = {
                                type: 'ERC20',
                                options: {
                                  address: KANGA_ADDRESS[chainId],
                                  symbol: 'KANGA',
                                  decimals: 18,
                                  image:
                                    'https://raw.githubusercontent.com/kangafinance/assets/master/blockchains/ethereum/assets/0x6B3595068778DD592e39A122f4f5a5cF09C90fE2/logo.png',
                                },
                              }
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added KANGA to MetaMask')
                                    } else {
                                      throw new Error('Something went wrong.')
                                    }
                                  })
                ...
                {chainId &&
                  [ChainId.MAINNET, ChainId.BSC, ChainId.XDAI, ChainId.FANTOM, ChainId.MATIC].includes(chainId) && (
                    <ExternalLink
                      ...
                      href={ANALYTICS_URL[chainId] || 'https://analytics.kanga.finance'}
                      className="p-2 text-baseline text-primary hover:text-high-emphesis focus:text-high-emphesis md:p-3 whitespace-nowrap"
                    >
                      {i18n._(t`Analytics`)}
                    </ExternalLink>
