...
const items = (i18n: I18n) => [
  {
    name: i18n._(t`Docs`),
    description: i18n._(t`Documentation for users of Kanga.`),
    href: 'https://docs.kanga.finance',
  },
  {
    name: i18n._(t`Dev`),
    description: i18n._(t`Documentation for developers of Kanga.`),
    href: 'https://dev.kanga.finance',
  },
  {
    name: i18n._(t`Open Source`),
    description: i18n._(t`Kanga is a supporter of Open Source.`),
    href: 'https://github.com/kangafinance',
  },
  {
    name: i18n._(t`Tools`),
  ...
  },
  {
    ...
    href: 'https://discord.kanga.finance',
  },
]
