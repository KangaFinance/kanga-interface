import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from '@kangafinance/sdk'
import { DAI, KANGA, USDC } from '../config/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [KANGA[1].address]: { type: PermitType.AMOUNT, name: 'KangaFinance' },
  },
  [4]: {
    ...
    [KANGA[4].address]: { type: PermitType.AMOUNT, name: 'KangaFinance' },
  },
  [3]: {
    [KANGA[3].address]: { type: PermitType.AMOUNT, name: 'KangaFinance' },
  ...
  [5]: {
    [KANGA[5].address]: { type: PermitType.AMOUNT, name: 'KangaFinance' },
  },
  [42]: {
    [KANGA[42].address]: { type: PermitType.AMOUNT, name: 'KangaFinance' },
  },
}
