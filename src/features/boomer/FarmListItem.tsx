              ...
              <div className="flex col-span-2 space-x-4 md:col-span-1">
                ...
                <div className="flex flex-col justify-center">
                  <div>
                    ...
                    <span className={farm?.pair?.type === PairType.TROOP ? 'font-thin' : 'font-bold'}>
                      {farm?.pair?.token1?.symbol}
                    </span>
                  </div>
                  {farm?.pair?.type === PairType.SWAP && (
                    <div className="text-xs md:text-base text-secondary">KangaFinance Farm</div>
                  )}
                  {farm?.pair?.type === PairType.TROOP && (
                    <div className="text-xs md:text-base text-secondary">Troop Farm</div>
                  )}
                </div>
              </div>
