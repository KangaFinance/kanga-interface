...
import { useDerivedJumpState, useJumpState, useSelectedJumpStrategy } from '../../state/jump/hooks'

import CurrencyLogo from '../../components/CurrencyLogo'
import { Field } from '../../state/jump/types'
import Input from '../../components/Input'
import Typography from '../../components/Typography'
import { setValues } from '../../state/jump/actions'
...
const BalancePanel: FC<BalancePanelProps> = ({ label, value, token, showMax = false, symbol, balance, field }) => {
  ...
  const { tokens } = useDerivedJumpState()
  const { calculateOutputFromInput } = useSelectedJumpStrategy()
