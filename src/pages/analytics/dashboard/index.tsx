import { useBlock, useEthPrice, useNativePrice, useKangaPairs, useTokens } from '../../../services/graph'
...
export default function Dashboard(): JSX.Element {
  ...
  const pairs1d = useKangaPairs({ block: block1d, chainId })
  const pairs1w = useKangaPairs({ block: block1w, chainId })
      ...
      farms
        ?.map((farm) => ({
          pair: {
            ...
            type: farm.pair.symbol ? 'Troop Farm' : 'Kanga Farm',
          },
    ...
    <AnalyticsContainer>
      <Background background="dashboard">
        <div className="grid items-center justify-between grid-cols-2">
          <div>
            <div className="text-3xl font-bold text-high-emphesis">Kanga Analytics</div>
            <div className="">
              Dive deeper in the analytics of billabong,
