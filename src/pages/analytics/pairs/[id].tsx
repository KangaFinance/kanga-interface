...
import { useBlock, useNativePrice, useKangaPairs, useTransactions } from '../../../services/graph'
...
export default function Pair() {
  ...
  const pair = useKangaPairs({ subset: [id], chainId })?.[0]
  const pair1d = useKangaPairs({ subset: [id], block: block1d, shouldFetch: !!block1d, chainId })?.[0]
  const pair2d = useKangaPairs({ subset: [id], block: block2d, shouldFetch: !!block2d, chainId })?.[0]
        ...
        <div className="items-center -mt-4 space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="text-xs text-secondary">Kanga Liquidity Pool</div>
            </div>
