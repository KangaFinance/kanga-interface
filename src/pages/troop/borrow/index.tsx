import Provider, { useTroopPairs } from '../../../features/troop/context'
...
import ListHeaderWithSort from '../../../features/troop/ListHeaderWithSort'
import MarketHeader from '../../../features/troop/MarketHeader'
...
function Borrow() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Borrow`)} | Kanga</title>
        <meta
          key="description"
          name="description"
          content="Troop is a lending and margin trading platform, built upon Mob, which allows for anyone to create customized and gas-efficient markets for lending, borrowing, and collateralizing a variety of DeFi tokens, stable coins, and synthetic assets."
        />
      </Head>
