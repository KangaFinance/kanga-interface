...
import FarmList from '../../features/boomer/FarmList'
import Head from 'next/head'
import Menu from '../../features/boomer/FarmMenu'
...
export default function Farm(): JSX.Element {
  ...
  const FILTER = {
    ...
    kanga: (farm) => farm.pair.type === PairType.SWAP && farm.allocPoint !== '0',
    troop: (farm) => farm.pair.type === PairType.TROOP && farm.allocPoint !== '0',
    '2x': (farm) =>
      (farm.breeder === Breeder.MASTERBREEDER_V2 || farm.breeder === Breeder.MINIBREEDER) && farm.allocPoint !== '0',
  }
  ...
  return (
    <Container id="farm-page" className="grid h-full grid-cols-4 py-4 mx-auto md:py-8 lg:py-12 gap-9" maxWidth="7xl">
      <Head>
        <title>Farm | Kanga</title>
        <meta key="description" name="description" content="Farm KANGA" />
      </Head>
