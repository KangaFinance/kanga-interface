import { ChainId, CurrencyAmount, JSBI, NATIVE, Pair } from '@kangafinance/sdk'
...
import { Currency } from '@kangafinance/sdk'
...
export default function Pool() {
  ...
  return (
    <Container id="pool-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Pool | Kanga</title>
        <meta
          key="description"
          name="description"
          content="KangaFinance liquidity pools are markets for trades between the two tokens, you can provide these tokens and become a liquidity provider to earn 0.25% of fees from trades."
        />
      </Head>
          ...
          {!account ? (
            ...
            <>
              {/* <div className="flex items-center justify-center">
                  <ExternalLink
                    href={"https://analytics.kanga.finance/user/" + account}
                  >
