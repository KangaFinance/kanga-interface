...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from '@kangafinance/sdk'
...
import { useRouterContract, useFactoryContract } from '../../../hooks'
...
export default function Add() {
  ...
  async function onAdd() {
    ...
    if (currencyA.isNative || currencyB.isNative) {
      ...
      console.log('Estimating Gas for addLiquidity')
    ...
    console.log(`RouterContract address: ${await routerContract.address}`)
    console.log(`args for addLiquidity: ${JSON.stringify(args)}`)
    // const factoryContract = useFactoryContract()
    console.log(`FactoryContract address: ${await factoryContract.address}`)

    setAttemptingTxn(true)
    console.log('Set Attempting Txn is true')
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | Kanga</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the KangaFinance AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
