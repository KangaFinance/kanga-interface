...
import { ChainId, Currency, NATIVE, Percent, WNATIVE, WNATIVE_ADDRESS } from '@kangafinance/sdk'
...
export default function Remove() {
  ...
  async function onAttemptToApprove() {
    ...
    console.log(`gatherPermitSignature: ${JSON.stringify(gatherPermitSignature)}`)

    if (chainId !== ChainId.HARMONY && chainId !== ChainId.HARMONY_TESTNET && gatherPermitSignature) {
      try {
  ...
  async function onRemove() {
    ...
    // we have a signature, use permit versions of remove liquidity
      ...
      console.log(`signatureData: ${JSON.stringify(signatureData)}`)
    ...
    console.log(`methodName: ${JSON.stringify(methodNames)}`)
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | Kanga</title>
        <meta key="description" name="description" content="Remove liquidity from the KangaFinance AMM" />
      </Head>
