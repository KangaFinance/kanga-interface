...
// TODO: CLASS B
export const getKangaFinanceLiquidityTransactions = (chainId = ChainId.MAINNET, address) =>
  fetch(`https://api.covalenthq.com/v1/${chainId}/address/${address}/stacks/kangafinance/acts/`).then((res) =>
    res.json()
  )
