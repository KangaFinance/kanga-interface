...
export const EXCHANGE = {
  [ChainId.MAINNET]: 'kanga/exchange',
  [ChainId.XDAI]: 'kanga/xdai-exchange',
  [ChainId.MATIC]: 'kanga/matic-exchange',
  [ChainId.FANTOM]: 'kanga/fantom-exchange',
  [ChainId.BSC]: 'kanga/bsc-exchange',
  [ChainId.HARMONY]: 'kanga/harmony-exchange',
  [ChainId.OKEX]: 'kanga/okex-exchange',
  [ChainId.AVALANCHE]: 'kanga/avalanche-exchange',
  [ChainId.CELO]: 'kanga/celo-exchange',
  [ChainId.ARBITRUM]: 'kanga/arbitrum-exchange',
...
export const getKangaPrice = async (variables = {}) => {
  // console.log('getKangaPrice')
  return getTokenPrice(ChainId.MAINNET, tokenPriceQuery, {
